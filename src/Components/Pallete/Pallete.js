    ...
    <>
      <div id="pallete">
        <div className="swatch">
          ...
          <BiEraser
            id="eraser"
            style={{ fontSize: "25px", color: "pink", cursor: "pointer" }}
            onClick={(e) => {
              toggleEraser();
            }}
          />
        ...
        <div className="swatch">
          ...
          <label className="custom">
            <input
              type="color"
              onChange={(e) => {
                toggleStrokeStyle(e.target.value);
              }}
            />
          </label>
        </div>
        <div id="brush-weight">
          <input
            ...
            orient="vertical"
            onChange={(e) => {
              toggleLineWidth(e.target.value);
            }}
          />
        </div>
        <div className="swatch">
          ...
          <div
            className="color"
            style={{ backgroundColor: "#354d42" }}
            onClick={(e) => {
              setChalkboardColor("#354d42");
            }}
          />
          <div
            className="color"
            ...
            onClick={(e) => {
              setChalkboardColor("#181818");
            }}
          />
          <div
            className="color"
            style={{ backgroundColor: "#194050" }}
            onClick={(e) => {
              setChalkboardColor("#194050");
            }}
          />
          <label className="custom">
            <input
              type="color"
              onChange={(e) => {
                setChalkboardColor(e.target.value);
              }}
            />
          </label>
        </div>
